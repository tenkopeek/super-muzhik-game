...
from lib.logic import Camera
from lib.logic import Collider
from lib.logic import EntityCollider
from lib.input import Input
from lib.graphics import Sprites
from lib.entities.EntityBase import EntityBase
from lib.entities.Mushroom import RedMushroom
from lib.movement import bounceTrait, GoTrait, JumpTrait
from lib.pause import Pause

spriteCollection = Sprites().spriteCollection
smallAnimation = Animation(
    [
        spriteCollection["player_run1"].image,
        spriteCollection["player_run2"].image,
        spriteCollection["player_run3"].image,
    ],
    spriteCollection["player_idle"].image,
    spriteCollection["player_jump"].image,
)
bigAnimation = Animation(
    [
        spriteCollection["player_big_run1"].image,
        spriteCollection["player_big_run2"].image,
        spriteCollection["player_big_run3"].image,
    ],
    spriteCollection["player_big_idle"].image,
    spriteCollection["player_big_jump"].image,
)
