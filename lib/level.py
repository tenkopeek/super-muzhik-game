...
from lib.graphics import Sprites, Tile

from lib.entities.Coin import Coin
from lib.entities.CoinBrick import CoinBrick
from lib.entities.Goomba import Goomba
from lib.entities.Mushroom import RedMushroom
from lib.entities.Koopa import Koopa
from lib.entities.CoinBox import CoinBox
from lib.entities.RandomBox import RandomBox
...
class Level:
    ...
    def loadLevel(self, levelname):
        with open("./assets/levels/{}.json".format(levelname)) as jsonData:
